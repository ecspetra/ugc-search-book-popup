...
$('.ba-advantage__item').onAppearanceAddClass('ba-animat');
$('.ba-about__item').onAppearanceAddClass('ba-animat');
$('.ba-infographic-gender__item span').onAppearanceAddClass('ba-animat-duo');
$('.ba-infographic-age__item').onAppearanceAddClass('ba-animat-duo');
$('.ba-infographic-age__item span').onAppearanceAddClass('ba-animat');